...
export class ProfessoresService {
  private apiUrl = 'https://api.projetointegradoratividade.duckdns.org/teacher/';  // Nova URL da API
  private cursosUrl = 'https://api.projetointegradoratividade.duckdns.org/courses'; // Caso precise acessar cursos também
