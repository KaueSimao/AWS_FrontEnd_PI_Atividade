...
export class CcursoService {
  private apiUrl = 'https://api.projetointegradoratividade.duckdns.org/course/';  // URL principal para cursos
  private disciplinesUrl = 'https://api.projetointegradoratividade.duckdns.org/subject/';  // URL para buscar as disciplinas
