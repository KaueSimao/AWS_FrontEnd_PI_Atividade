  ...
  export class GhorarioService {
    private apiUrl = 'https://api.projetointegradoratividade.duckdns.org/reservation/';
    private teachersUrl = 'https://api.projetointegradoratividade.duckdns.org/teacher/';
    private subjectsUrl = 'https://api.projetointegradoratividade.duckdns.org/subject/';
    private timesUrl = 'https://api.projetointegradoratividade.duckdns.org/time/';
    private roomsUrl = 'https://api.projetointegradoratividade.duckdns.org/rooms/';
    private coursesUrl = 'https://api.projetointegradoratividade.duckdns.org/course/';
